...
pub fn core_host_lang() -> String {
    return _lia_val("rust");
}
pub fn cli_default_lang() -> String {
    return _lia_val("ts");
}
pub fn bootstrap_lang() -> String {
    return _lia_val("js");
}
pub fn gateway_lang() -> String {
    return _lia_val("go");
}
pub fn unsafe_target_lang() -> String {
    return _lia_val("c");
}
pub fn phase1_name() -> String {
    return _lia_val("ast_parser");
}
pub fn ast_kind_fn() -> String {
    return _lia_val("fn");
}
pub fn ast_kind_if() -> String {
    return _lia_val("if");
}
pub fn ast_kind_for() -> String {
    return _lia_val("for");
}
pub fn ast_kind_ret() -> String {
    return _lia_val("ret");
}
pub fn core_banner() -> String {
    return _lia_val(("core=rust rank=1 cli=ts bootstrap=js gateway=go c=unsafe phase=ast_parser"));
}
pub fn rank1_lang() -> String {
    return _lia_val("rust");
}
pub fn rank2_lang() -> String {
    return _lia_val("ocaml");
}
pub fn rank3_lang() -> String {
    return _lia_val("zig");
}

fn main() {
    println!("{}", core_banner());
    println!("{}", core_host_lang());
    println!("{}", cli_default_lang());
    println!("{}", bootstrap_lang());
    println!("{}", gateway_lang());
    println!("{}", unsafe_target_lang());
    println!("{}", phase1_name());
    println!("{}", rank1_lang());
    println!("{}", rank2_lang());
    println!("{}", rank3_lang());

...
pub fn classify_status(code: i64) -> String {
    match code {
        200 | 201 | 204 => {
            return _lia_val("SUCCESS");
        }
        400 | 401 | 403 | 404 => {
            return _lia_val("CLIENT_ERROR");
        }
        500 | 502 | 503 => {
            return _lia_val("SERVER_ERROR");
        }
        _ => {
...
pub fn evaluate_score(score: i64) -> String {
    match score {
        s if s >= 90 => {
            return _lia_val("EXCELLENT");
        }
        s if s >= 70 => {
            return _lia_val("GOOD");
        }
        s if s >= 50 => {
            return _lia_val("PASS");
        }
        _ => {
            return _lia_val("FAIL");
        }
    }
}
pub fn match_bool(flag: bool) -> i64 {
    match flag {
        true => {
            return 1;
        }

...
pub struct UsedPoint {
    pub x: i64,
    pub y: i64,
}
pub mod ActiveMath {
    use super::*;
    pub fn usedAdd(a: i64, b: i64) -> i64 {
        return a + b;
    }
}
pub use ActiveMath::usedAdd;
pub fn live_compute(a: i64, b: i64) -> i64 {
    let mut pt: UsedPoint = Default::default();
    pt = UsedPoint { x: a, y: b };

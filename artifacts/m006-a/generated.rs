...
pub fn safe_div(value: impl ToString, divisor: impl ToString) -> i64 {
    let mut value = value.to_string();
    let mut divisor = divisor.to_string();
    return _lia_num(&value)/_lia_num(&divisor);
}
pub fn classify(mut n: i64) -> i64 {
    match n {
        1 => {
            return 10;
        }

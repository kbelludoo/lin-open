...
pub mod Storage {
    use super::*;
    pub fn readEntry(key: String) -> String {
        return _lia_val(_lia_cat(&"ENTRY:",&key));
    }
    pub fn writeEntry(key: String, value: String) -> String {
        return _lia_val(_lia_cat(&_lia_cat(&"STORED:",&key),&_lia_cat(&"=",&value)));
    }
}
// @caps: io, state
pub use Storage::{readEntry, writeEntry};
pub fn query_data(key: String) -> String {
    return _lia_val(readEntry(key));
}
pub fn save_data(key: String, value: String) -> String {
    return _lia_val(writeEntry(key, value));
}

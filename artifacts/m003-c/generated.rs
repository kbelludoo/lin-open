...
pub fn sum_tuple(t: (i64, i64)) -> i64 {
    match t {
        (0, y) => {
            return y;
        }
...
pub fn eval_point(p: Point) -> String {
    match p {
        Point { x: 0, y: 0 } => {
            return _lia_val("ORIGIN");
        }
        Point { x: 0, y } => {
            return _lia_val("Y_AXIS");
        }
        Point { x, y: 0 } => {
            return _lia_val("X_AXIS");
        }
        Point { x, y } if x == y => {
            return _lia_val("DIAGONAL");
        }
        _ => {
            return _lia_val("QUADRANT");
        }
    }
}

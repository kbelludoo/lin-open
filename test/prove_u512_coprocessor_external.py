...
No Zig. 256x256->512 mul, 512/256 div with q*d+r==n, 512-bit ge.
Oracles: Python int, C11 16-bit, C11 64-bit __int128, Node BigInt,
OpenSSL BIGNUM, Go math/big (geth-family). LNR1 + LCR2 + LCR2-full +
LGE1 + LRI1 remainder-identity receipts. Zero-LIN Python/Node auditors.
...
def main() -> int:
    ...
    evidence = {
        "schema": "LIN_U512_COPROCESSOR_EVIDENCE_1.5",
        "class": "EXPERIMENTAL",
        ...
        "lri1_merkle": ri["root"],
        "audit": "zero-LIN Python and Node verifiers recompute LNR1, LCR2, LCR2-full, LGE1, and LRI1 merkles",
        "pins": {

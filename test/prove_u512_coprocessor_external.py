...
Go math/big, Java BigInteger, GNU MP mpz. LNR1+LCR2+LCR2-full+LGE1+LRI1 + LIP1 inclusion.
...
from prove_u512_inclusion import (
    VERIFY_INC, VERIFY_INC_JS, inclusion_auditor_tuples, java_check_tuples, make_lip1,
)
...
def main() -> int:
    ...
    evidence = {
        "schema": "LIN_U512_COPROCESSOR_EVIDENCE_1.7",
        "class": "EXPERIMENTAL",
        ...
        "audit": "zero-LIN Python/Node recompute five merkles; LIP1 inclusion verifies one leaf without the campaign; packed LCR2 binds to ref_amount_out",
        "pins": {

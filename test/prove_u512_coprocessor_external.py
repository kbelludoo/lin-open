...
Node BigInt, OpenSSL BN, Go math/big, Java BigInteger, GNU MP mpz,
...
def main() -> int:
    ...
    evidence = {
        "schema": "LIN_U512_COPROCESSOR_EVIDENCE_1.10",
        "class": "EXPERIMENTAL",

...
Python radix-2^8, Knuth Algorithm D (normalized long division), Node BigInt,
OpenSSL BN, Go math/big, Java BigInteger, GNU MP mpz, Perl Math::BigInt::Calc,
POSIX GNU bc. LNR1+LCR2+LCR2-full+LGE1+LRI1 + LIP1 inclusion (all LCR2 and
LCR2-full). EXPERIMENTAL FullMath width, not CRT, not a pool, not the 2000/157
campaign.
"""

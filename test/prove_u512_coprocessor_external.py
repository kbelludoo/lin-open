...
Go math/big, Java BigInteger. LNR1+LCR2+LCR2-full+LGE1+LRI1 + LIP1 inclusion.
...
def main() -> int:
    ...
    evidence = {
        "schema": "LIN_U512_COPROCESSOR_EVIDENCE_1.6",
        "class": "EXPERIMENTAL",
        ...
        "audit": "zero-LIN Python/Node recompute five merkles; LIP1 inclusion verifies one leaf without the campaign",
        "pins": {

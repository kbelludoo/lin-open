...
This run (no Zig):
  ...
  * C11 64-bit path checks q*d+r==n; C11 self-test covers 512-bit ge
...
from prove_u512_lib import (
    ...
    from_words, lcr2, lcr2_dict, leaf_dict, lin, lnr1, merkle, node_root, openssl_sha256,
...
def main() -> int:
    ...
    evidence = {
        ...
        "audit": "zero-LIN verifier recomputes lnr1_merkle and lcr2_merkle from published leaves",
        "pins": {

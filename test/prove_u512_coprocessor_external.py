...
Newton inverse, Karatsuba + Barrett, Toom-3 + Goldschmidt, Node BigInt, OpenSSL BN, Go math/big, Java
...
def main() -> int:
    ...
    evidence = {
        "schema": "LIN_U512_COPROCESSOR_EVIDENCE_1.15",
        "class": "EXPERIMENTAL",
    ...
    print("self_gate_steps", s_gate, "class EXPERIMENTAL Toom-3+Goldschmidt auditor not EVM mulmod not a pool")

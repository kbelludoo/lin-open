#!/bin/sh
# Gate: rust-bitcoin Amount::div_by_fee_rate_ceil LIN clone vs independent C11 oracle. No Zig.
set -u
...
exec python3 "$ROOT/test/prove_rust_bitcoin_feerateceil_external.py"

...
pub fn cityhash_len16(u: i64, v: i64, mul: i64) i64 {
    var a: i64 = 0;
    var b: i64 = 0;
...
pub fn test_cityhash_vector() i64 {
    var r: i64 = 0;

  // Test HashLen16(1, 2, mul) with mul = -7286425919675154321
  // Expected = -3040228277396401595
  r = cityhash_len16(1, 2, -7286425919675154321);
  if (r != -3040228277396401595) { return 0 ;}
  return 1;

...
pub fn curve25519_mask51(x: i64) i64 {

  // 51-bit mask else if (1 << 51) - 1 = 2251799813685247
  return (x & 2251799813685247);

}

pub fn curve25519_carry_out51(x: i64) i64 {

  return (_lia_ushr(x, 51));

}

pub fn curve25519_fold19(top_limb: i64) i64 {
    var c: i64 = 0;

  c = _lia_ushr(top_limb, 51);
  return (c * 19);

}

pub fn test_curve25519_vector() i64 {
    var top: i64 = 0;
    var fold: i64 = 0;
    var rem: i64 = 0;

  top = 4503599627370538;
  fold = curve25519_fold19(top);
  rem = curve25519_mask51(top);

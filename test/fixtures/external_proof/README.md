...
| `CToken_exchangeRateStoredInternal.sol` | [compound-finance/compound-protocol](https://github.com/compound-finance/compound-protocol) `CToken.sol` excerpt | BSD-3-Clause |

...
| `FloorDataGas.go` | [ethereum/go-ethereum](https://github.com/ethereum/go-ethereum) v1.16.9 `core/state_transition.go` excerpt | LGPL-3.0 |
| `eip7623_protocol_params.go` | [ethereum/go-ethereum](https://github.com/ethereum/go-ethereum) v1.16.9 `params/protocol_params.go` excerpt | LGPL-3.0 |

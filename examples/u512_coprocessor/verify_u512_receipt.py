...
# -*- coding: utf-8 -*-
"""
Zero-LIN auditor for the u512 coprocessor receipt (schema 1.3).

Recomputes LNR1, LCR2 (SafeMath-width settler), and LCR2-full (settle_u512_swap
with 512-bit numerator) from published leaves. Remainder identity on MULDIV.
Does not run LinVM.
...
def main() -> int:
    ...
    if ev.get("schema") != "LIN_U512_COPROCESSOR_EVIDENCE_1.3":
        return fail("schema")
    ...
    print("lcr2_full_merkle", full_root)
    return 0

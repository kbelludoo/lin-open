...
# -*- coding: utf-8 -*-
"""
Zero-LIN auditor for the u512 coprocessor receipt (schema 1.4).

Recomputes LNR1, LCR2 (SafeMath-width settler), LCR2-full (settle_u512_swap
with 512-bit numerator), and LGE1 (512-bit ge) from published leaves.
Remainder identity on MULDIV. Does not run LinVM.
...
def main() -> int:
    ...
    if ev.get("schema") != "LIN_U512_COPROCESSOR_EVIDENCE_1.4":
        return fail("schema")

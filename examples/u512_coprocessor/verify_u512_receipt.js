#!/usr/bin/env node
/* Zero-LIN Node auditor (schema 1.4). Recomputes LNR1 + LCR2 + LCR2-full + LGE1
 * merkles, remainder identity, and 512-bit ge. Does not run LinVM. */
"use strict";
...
function main() {
  ...
  if (ev.schema !== "LIN_U512_COPROCESSOR_EVIDENCE_1.4") fail("schema");

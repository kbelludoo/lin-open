#!/usr/bin/env node
/* Zero-LIN Node auditor (schema 1.3). Recomputes LNR1 + LCR2 + LCR2-full merkles
 * and remainder identity with BigInt. Does not run LinVM. */
"use strict";
...
function main() {
  ...
  if (ev.schema !== "LIN_U512_COPROCESSOR_EVIDENCE_1.3") fail("schema");

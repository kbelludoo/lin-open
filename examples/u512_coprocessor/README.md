...
`--self-test` flips one bit of the first leaf and requires the auditor to
reject it. Step counts are recorded in the receipt; confirming them needs a
LinVM re-run (`lin_c0 run`).

...
ge em 512 bits; consenso Python `int` + C11 + Node BigInt. Merkle LNR1 (Python / Node /
C11 `lin_sha256` / OpenSSL) rejeita tamper de 1 bit. Schema 1.3: verificadores zero-LIN
em **Python e Node** recomputam as raízes LNR1, LCR2 (largura SafeMath) **e** LCR2-full
(512-bit numerator via `settle_u512_swap`) a partir das folhas publicadas.

...
| :--- | :--- | :---: | :---: |
| **M1: Canonical Transaction Verifier** | **M1-A (Delivered):** Reference Python & Pure Mojo prototypes (`tools/lin_audit_tx.mojo`), RLP/Keccak CLI, and mutation suite.<br>**M1-B (Grant Scope):** Execute migration trajectory (`Python -> Mojo -> LinVM`), port Keccak-256/RLP to the LinVM execution kernel under profile `LIN-ETH-1`, 4-way differential cross-checking (LinVM vs. Mojo vs. Python vs. Geth/Reth), and scaling to 10,000 Mainnet fixtures. | Months 1–2 | $10,000 |

...
- **M1-B.1: First Executable Keccak-256 Core in LinVM (`src/lin_ethereum_keccak.lin` & `test/ethereum_tx/test_linvm_keccak.py`):**
  ...
  - Formal 3-tier tracking documented in [`docs/m1_phase_comparison.csv`](file:///home/k/Downloads/lin-master/docs/m1_phase_comparison.csv) and [`docs/m1_phase_comparison.svg`](file:///home/k/Downloads/lin-master/docs/m1_phase_comparison.svg).

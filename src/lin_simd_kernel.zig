...
pub fn simd_avalanche8(h: @Vector(8, u32)) @Vector(8, u32) {
    var hash: @Vector(8, u32) = @splat(0);
    var prime2: u32 = 0;
    var prime3: u32 = 0;
    var p2_vec: @Vector(8, u32) = @splat(0);
    var p3_vec: @Vector(8, u32) = @splat(0);
    var s15: @Vector(8, u5) = @splat(0);
    var s13: @Vector(8, u5) = @splat(0);
    var s16: @Vector(8, u5) = @splat(0);

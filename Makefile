...
.PHONY: compound-jumprate-proof independent-reproof geth-memorygas-proof
...
geth-memorygas-proof: c0
	@chmod +x test/verify_geth_memorygas.sh test/prove_geth_memorygas_external.py
	@test/verify_geth_memorygas.sh

...
.PHONY: compound-jumprate-proof independent-reproof geth-callgas-proof
...
geth-callgas-proof: c0
	@chmod +x test/verify_geth_callgas.sh test/prove_geth_callgas_external.py
	@test/verify_geth_callgas.sh

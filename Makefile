...
.PHONY: compound-jumprate-proof independent-reproof bitcoin-perm-diff-proof
...
bitcoin-perm-diff-proof: c0
	@chmod +x test/verify_bitcoin_perm_diff.sh test/prove_bitcoin_perm_diff_external.py

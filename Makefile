...
.PHONY: compound-jumprate-proof eth-base-reward-proof independent-reproof
...
eth-base-reward-proof: c0
	@chmod +x test/verify_eth_base_reward.sh test/prove_eth_base_reward_external.py
	@test/verify_eth_base_reward.sh

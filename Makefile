...
.PHONY: compound-jumprate-proof independent-reproof rust-bitcoin-weightceil-proof
...
rust-bitcoin-weightceil-proof: c0
	@chmod +x test/verify_rust_bitcoin_weightceil.sh test/prove_rust_bitcoin_weightceil_external.py
	@test/verify_rust_bitcoin_weightceil.sh

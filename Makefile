...
# 512-bit numeric coprocessor: mul 256x256->512, ge_512, restoring 512/256,
# remainder identity, LNR1 receipt. Python int + C11 oracles, no Zig.
# Does NOT close settle_u256_word EXACT/OVERPAID e2e (see the event file).

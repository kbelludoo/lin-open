...
.PHONY: compound-jumprate-proof independent-reproof oz-log10-proof
...
oz-log10-proof: c0
	@chmod +x test/verify_oz_log10.sh test/prove_oz_log10_external.py
	@test/verify_oz_log10.sh

...
.PHONY: compound-jumprate-proof bitcoin-nbits-proof independent-reproof
...
bitcoin-nbits-proof: c0
	@chmod +x test/verify_bitcoin_nbits.sh test/prove_bitcoin_nbits_external.py
	@test/verify_bitcoin_nbits.sh

...
.PHONY: compound-jumprate-proof independent-reproof eip4844-blobfee-proof
...
eip4844-blobfee-proof: c0
	@chmod +x test/verify_eip4844_blobfee.sh test/prove_eip4844_blobfee_external.py
	@test/verify_eip4844_blobfee.sh

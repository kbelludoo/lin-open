...
.PHONY: compound-jumprate-proof compound-seize-proof independent-reproof
...
compound-seize-proof: c0
	@chmod +x test/verify_compound_seize.sh test/prove_compound_seize_external.py
	@test/verify_compound_seize.sh

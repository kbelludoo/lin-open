...
.PHONY: compound-jumprate-proof independent-reproof solady-mulwad-proof
...
solady-mulwad-proof: c0
	@chmod +x test/verify_solady_mulwad.sh test/prove_solady_mulwad_external.py
	@test/verify_solady_mulwad.sh

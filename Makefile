...
#   + Go math/big (geth-family). LNR1 quad-auditor; LCR2 + LCR2-full + LGE1
#   + LRI1 remainder-identity (q*d+r==n over published 512-bit n).
#   Zero-LIN Python AND Node verifiers recompute five merkles.

...
.PHONY: compound-jumprate-proof independent-reproof geth-floordata-proof
...
geth-floordata-proof: c0
	@chmod +x test/verify_geth_floordata.sh test/prove_geth_floordata_external.py
	@test/verify_geth_floordata.sh

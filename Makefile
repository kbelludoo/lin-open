...
.PHONY: compound-jumprate-proof independent-reproof bitcoin-core-getfee-proof
...
bitcoin-core-getfee-proof: c0
	@chmod +x test/verify_bitcoin_core_getfee.sh test/prove_bitcoin_core_getfee_external.py
	@test/verify_bitcoin_core_getfee.sh

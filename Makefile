...
.PHONY: compound-jumprate-proof geth-eip7918-proof independent-reproof
...
geth-eip7918-proof: c0
	@chmod +x test/verify_geth_eip7918.sh test/prove_geth_eip7918_external.py
	@test/verify_geth_eip7918.sh

...
#   + Go math/big + Java BigInteger. LNR1 quad-auditor; LCR2 + LCR2-full +
#   LGE1 + LRI1 remainder-identity + LIP1 Merkle inclusion (one leaf vs root).
#   Zero-LIN Python AND Node verifiers recompute five merkles and LIP1 paths.
